# Power BI Dashboard Template – Marketing Campaign Analytics

Use this guide to build a **Marketing Campaign Analytics** dashboard in Power BI Desktop using the exports from this project.
